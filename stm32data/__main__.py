...
perimap = [
    ...
    ('.*:RTC:rtc1_v1_1_Cube', ('rtc', 'v1', 'RTC')),
    ('STM32F0.*:RTC:rtc2_.*', ('rtc', 'v2-f0', 'RTC')),
    ('STM32F2.*:RTC:rtc2_.*', ('rtc', 'v2-f2', 'RTC')),
    ('STM32F3.*:RTC:rtc2_.*', ('rtc', 'v2-f3', 'RTC')),
    ('STM32F4.*:RTC:rtc2_.*', ('rtc', 'v2-f4', 'RTC')),
    ('STM32F7.*:RTC:rtc2_.*', ('rtc', 'v2-f7', 'RTC')),
    ('STM32H7.*:RTC:rtc2_.*', ('rtc', 'v2-h7', 'RTC')),
