...
pub static PERIMAP: RegexMap<(&str, &str, &str)> = RegexMap::new(&[
    ...
    ("STM32H7[RS].*:SPI:.*", ("spi", "v4", "SPI")),
    ("STM32H7.*:SPI:.*", ("spi", "v3", "SPI")),
    ("STM32F1.*:SPI:.*", ("spi", "f1", "SPI")),
    ("STM32F2.*:SPI:.*", ("spi", "v1", "SPI")),
    ("STM32F4.*:SPI:.*", ("spi", "v1", "SPI")),
    ("STM32L0.*:SPI:.*", ("spi", "v1", "SPI")),
    ("STM32L1.*:SPI:.*", ("spi", "v1", "SPI")),
    ("STM32C0.*:SPI:.*", ("spi", "v2", "SPI")),
    ("STM32F0.*:SPI:.*", ("spi", "v2", "SPI")),
    ("STM32F3.*:SPI:.*", ("spi", "v2", "SPI")),
    ("STM32F7.*:SPI:.*", ("spi", "v2", "SPI")),
    ("STM32G0.*:SPI:.*", ("spi", "v2", "SPI")),
    ("STM32G4.*:SPI:.*", ("spi", "v2", "SPI")),
    ("STM32L4.*:SPI:.*", ("spi", "v2", "SPI")),
    ("STM32L5.*:SPI:.*", ("spi", "v2", "SPI")),
    ("STM32U0.*:SPI:.*", ("spi", "v2", "SPI")),
    ("STM32WBA.*:SPI:.*", ("spi", "v5", "SPI")),
    ("STM32WB.*:SPI:.*", ("spi", "v2", "SPI")),
    ("STM32WL.*:SPI:.*", ("spi", "v2", "SPI")),
    ("STM32H5.*:SPI:.*", ("spi", "v4", "SPI")),
    ("STM32N6.*:SPI:.*", ("spi", "v4", "SPI")),
    ("STM32U5.*:SPI:.*", ("spi", "v5", "SPI")),
