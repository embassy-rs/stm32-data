...
pub static PERIMAP: RegexMap<(&str, &str, &str)> = RegexMap::new(&[
    ...
    (".*:DAC:WL33_dacif_v3_0.*", ("dac", "wl33", "DAC")),
    ...
    (".*:ADC:aditf5_v1_0_WL3*", ("adc", "wl3", "ADC")),
    ...
    ("STM32WL3.*:SYSCFG:.*", ("syscfg", "wl3", "SYSCFG")),
    ...
    ("STM32WL3.*:RTC:rtc2_.*", ("rtc", "wl3", "RTC")),
    ...
    ("STM32WL3.*:FLASH:.*", ("flash", "wl3", "FLASH")),
    ...
    // Override for STM32L1 and STM32WL3 serials
    ("STM32(L1|WL3).*:TIM2:.*", ("timer", "v1", "TIM_GP16")),
    ...
    ("STM32WL3.*:DBGMCU:.*", ("dbgmcu", "wl3", "DBGMCU")),
    ...
    ("STM32WL3.*:DMAMUX.*", ("dmamux", "wl3", "DMAMUX")),
    ...
    ("STM32(H7|U5|WBA).*:VREFBUF:.*", ("vrefbuf", "v2a1", "VREFBUF")),
    ...
    // STM32WL3 specific peripherals
    ("STM32WL3.*:MRSUBG:.*", ("mrsubg", "v1", "MRSUBG")),
    ("STM32WL3.*:LPAWUR:.*", ("lpawur", "v1", "LPAWUR")),
    ("STM32WL3.*:LCSC:.*", ("lcsc", "v1", "LCSC")),
]);
