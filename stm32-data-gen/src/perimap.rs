...
pub static PERIMAP: RegexMap<(&str, &str, &str)> = RegexMap::new(&[
    ...
    (".*:AES:aes1_v1_0", ("aes", "v1", "AES")),
    (".*:AES:aes2_v1_[01]", ("aes", "v2a", "AES")),
    (".*:AES:aes3_v1_0_(F4|F7)", ("aes", "v2a", "AES")),
    (".*:AES:aes3_v1_0.*", ("aes", "v2b", "AES")),
    (".*:AES:aes3_v2_0_U5", ("aes", "v3a", "AES")),
    (".*:AES:aes3_v2_0_(H5|WBA)", ("aes", "v3b", "AES")),
    ...
    ("STM32L4.*:RTC:rtc3_v2_0.*", ("rtc", "v3l4", "RTC")), // A slightly cut down v3 RTC
