...
pub static PERIMAP: RegexMap<(&str, &str, &str)> = RegexMap::new(&[
    ...
    ("STM32G4.*:OPAMP:.*", ("opamp", "g4", "OPAMP")),
    ("STM32F3.*:OPAMP:.*", ("opamp", "f3", "OPAMP")),
    ("STM32H[57].*:OPAMP:.*", ("opamp", "h", "OPAMP")),
    ("STM32L[45].*:OPAMP:.*", ("opamp", "l4u0", "OPAMP")),
    ("STM32U[035].*:OPAMP:.*", ("opamp", "l4u0", "OPAMP")),
    (".*:DCMI:.*", ("dcmi", "v1", "DCMI")),
    ...
    ("STM32C0[13]1.*:RTC:rtc3_.*", ("rtc", "v1c0", "RTC")),
    ("STM32C071.*:RTC:rtc3_.*", ("rtc", "v2c0", "RTC")),
