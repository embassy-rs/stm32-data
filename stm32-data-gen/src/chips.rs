...
impl PeriMatcher {
    fn new() -> Self {
        const PERIMAP: &[(&str, (&str, &str, &str))] = &[
            ...
            ("STM32H7.*:HSEM:hsem1_v1_0", ("hsem", "h7", "HSEM")),
            ("STM32WB55.*:HSEM:hsem1_v1_0", ("hsem", "wb55", "HSEM")),
            ("STM32WLE.*:HSEM:hsem1_v1_0", ("hsem", "wle", "HSEM")),
            ("STM32WL5.*:HSEM:hsem1_v1_0", ("hsem", "wl5", "HSEM")),
