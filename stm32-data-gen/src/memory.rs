...
static MEMS: RegexMap<&[Mem]> = RegexMap::new(&[
    ...
    // G4. TODO: check
    ("STM32G4...6",                  mem!(BANK_1 0x08000000 32, SRAM 0x20000000 32, SRAM2 0x20004000 0)),
    ("STM32G4...8",                  mem!(BANK_1 0x08000000 64, SRAM 0x20000000 32, SRAM2 0x20004000 0)),
    ("STM32G4[34]..B",               mem!(BANK_1 0x08000000 128, SRAM 0x20000000 32, SRAM2 0x20004000 0)),
