...
static MEMS: RegexMap<&[&[Mem]]> = RegexMap::new(&[
    ...
    // WB0
    ("STM32WB05.Z",                  &[mem!(BANK_1 { 0x1004000 192}, SRAM0 { 0x2000000 12 }, SRAM1 { 0x20003000 12 }, OTP { 0x10001800 1 })]),
    ("STM32WB06.C",                  &[mem!(BANK_1 { 0x1004000 256}, SRAM0 { 0x2000000 16 }, SRAM1 { 0x20004000 16 }, OTP { 0x10001800 1 })]),
    ("STM32WB07.C",                  &[mem!(BANK_1 { 0x1004000 256}, SRAM0 { 0x2000000 16 }, SRAM1 { 0x20004000 16 }, SRAM2 { 0x20008000 16 }, SRAM3 { 0x2000C000 16 }, OTP { 0x10001800 1 })]),
    ("STM32WB09.E",                  &[mem!(BANK_1 { 0x1004000 512}, SRAM0 { 0x2000000 16 }, SRAM1 { 0x20004000 16 }, SRAM2 { 0x20008000 16 }, SRAM3 { 0x2000C000 16 }, OTP { 0x10001800 1 })]),
    // WBA
